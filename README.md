...
・お店の特徴や強み、基本情報などに加えて、理容室ならではのメニューやサービスも豊富で、伝えたい情報が多くありました。それらが複雑になってしまわないよう簡潔にまとめる必要がありました。
<br />
<br />

### 2. メニューを確認しやすくしたい
- お店に訪れることが決まっている方にとっても、他のお店と料金を比較したい方にとっても、メニューはとても大切な情報なので、特に気を配る必要がありました。
...
・お店の雰囲気やターゲット層について理解を深め、単に「女性向け」のデザインに寄せるのではなく、お店のイメージに合った優しさや安心感が感じられるサイトにすることを意識しました。
...
### 2.メニューへの配慮
- 画像をそのまま貼り出すのではなく、table要素を使用して表に作り直しました。視覚障がいのある方への配慮や更新・検索のしやすさ向上、誰が見ても分かりやすいメニューになるよう工夫しました。
